...
//        vpLayoutParams.setMargins(40,0,0,0);
        addView(mRecyclerView, vpLayoutParams);
        mLayoutManager = new BannerLayoutManager(getContext(), orientation);
        mRecyclerView.setLayoutManager(mLayoutManager);
//        mLayoutManager.setMaxVisibleItemCount(2);
//        mRecyclerView.setLayoutManager(initLayoutManger());
//        new PagerSnapHelper().attachToRecyclerView(mRecyclerView);//一页显示三个对称显示
        new StartPagerSnapHelper().attachToRecyclerView(mRecyclerView);
