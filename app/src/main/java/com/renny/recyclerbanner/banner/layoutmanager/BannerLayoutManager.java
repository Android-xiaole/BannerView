...
public class BannerLayoutManager extends LinearLayoutManager
    ...
    private float centerScale = 1.2f;//控制缩放比例
    /**
...
//        ViewGroup.LayoutParams params = scrap.getLayoutParams();
...
//        marginParams.setMargins(0,0,-40,0);
        ...
        Log.e("test","长"+mDecoratedMeasurement+"\n"+"宽"+mDecoratedMeasurementInOther);
    ...
    private void layoutItems0(RecyclerView.Recycler recycler) {
//        detachAndScrapAttachedViews(recycler);
    ...
    boolean onLayoutCompleted = false;
    @Override
    ...
    public void onScrollStateChanged(int state) {
        ...
        this.state = state;
//        mOffset = 0;
        Log.e("test","onScrollStateChanged"+state);
    }
    ...
    public void scrollToPosition(int position) {
        ...
        Log.e("test","scrollToPosition mOffset:"+mOffset);
        requestLayout();
    }
    ...
    public int scrollHorizontallyBy(int dx, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.e("test","scrollHorizontallyBy:"+dx);
    ...
    private void layoutItems(RecyclerView.Recycler recycler) {
        ...
        for (int i = start; i < end; i++) {
            if (useMaxVisibleCount() || !removeCondition(getProperty(i) - mOffset)) {
                ...
                resetViewProperty(scrap);
                // we need i to calculate the real offset of current view
                Log.e("test","layoutItems getProperty(i):"+getProperty(i));
                float targetOffset = getProperty(i) - mOffset;
//                float targetOffset = propertyChangeWhenScroll(scrap) - realDx;
                Log.e("test","layoutItems mOffset"+mOffset);
                Log.e("test","layoutItems targetOffset:"+targetOffset);
                layoutScrap(scrap, targetOffset);
                final float orderWeight = mEnableBringCenterToFront ?
                        setViewElevation(scrap, targetOffset) : adapterPosition;
                if (orderWeight > lastOrderWeight) {
    ...
    private void layoutScrap(View scrap, float targetOffset) {
        Log.e("test","layoutScrap - targetOffset"+targetOffset);
        ...
        if (mOrientation == VERTICAL) {
            ...
            Log.e("test","layoutScrap - left:"+left);
...
//                        mSpaceMain + left + mDecoratedMeasurement, mSpaceInOther + top + mDecoratedMeasurementInOther);
     ...
     * the view will be removed and recycled in {@link #(RecyclerView.Recycler)}
     */
...
//     * the view will be removed and recycled in {@link #(RecyclerView.Recycler)}
    ...
    protected float propertyChangeWhenScroll(View itemView) {
        Log.e("test","propertyChangeWhenScroll itemView.getLeft:"+itemView.getLeft());
        if (mOrientation == VERTICAL)
